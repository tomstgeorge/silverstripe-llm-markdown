...
use SilverStripe\StaticPublishQueue\Job\GenerateStaticCacheJob as BaseGenerateStaticCacheJob;
use SilverStripe\StaticPublishQueue\Publisher;

/**
 * Runs llm.txt regeneration at the end of the job when config allows.
 */
class GenerateStaticCacheJob extends BaseGenerateStaticCacheJob
{
